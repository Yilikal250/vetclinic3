...
**[Vet clinic Database]** is A relational database to create the initial data structure for a vet clinic.

## 🛠 Built With <a name="Postgressql"></a>
...
To run the project, open postgres and run the commands inside the data.sql,schema.sql,queries.sql folders:
...
I would like to thank Microverse for giving us this platform and for organizing the files to learn. 
